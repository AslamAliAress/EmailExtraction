...
} = require("@xpla/xpla.js/dist/core/upgrade/proposals")
...
const recipient = "xpla17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp"

describe("Bank", () => {
  test("Send", () => {
    const msg = new MsgSend(address, recipient, [coin])
    expect(readMsg(msg)).toBe(
      "Send 1000000uluna to xpla17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp"
    )
  })
  ...
  test("Send multiple coins", () => {
    ...
    expect(readMsg(msg)).toBe(
      "Send 1000000ukrw,1000000uluna to xpla17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp"
    )
  })
})
...
describe("Staking", () => {
  const validator = "xplavaloper1dcegyrekltswvyy0xy69ydgxn9x8x32zdy3ua5"
  const source = "xplavaloper1krj7amhhagjnyg2tkkuh6l0550y733jnjnnlzy"

  test("Delegate", () => {
    const msg = new MsgDelegate(address, validator, coin)
    expect(readMsg(msg)).toBe(
      "Delegate 1000000uluna to xplavaloper1dcegyrekltswvyy0xy69ydgxn9x8x32zdy3ua5"
    )
  })
  ...
  test("Undelegate", () => {
    ...
    expect(readMsg(msg)).toBe(
      "Undelegate 1000000uluna to xplavaloper1dcegyrekltswvyy0xy69ydgxn9x8x32zdy3ua5"
    )
  })
  ...
  test("Redelegate", () => {
    ...
    expect(readMsg(msg)).toBe(
      "Redelegate 1000000uluna from xplavaloper1krj7amhhagjnyg2tkkuh6l0550y733jnjnnlzy to xplavaloper1dcegyrekltswvyy0xy69ydgxn9x8x32zdy3ua5"
    )
  })
  ...
  test("Withdraw rewards", () => {
    ...
    expect(readMsg(msg)).toBe(
      "Withdraw rewards from xplavaloper1dcegyrekltswvyy0xy69ydgxn9x8x32zdy3ua5"
    )
  })
})
...
describe("Wasm", () => {
  const contract = "xpla10llyp6v3j3her8u3ce66ragytu45kcmd9asj3u"
  test("Execute contract with coins", () => {
    const msg = new MsgExecuteContract(address, contract, { send: "" }, [coin])
    expect(readMsg(msg)).toBe(
      "Execute send on xpla10llyp6v3j3her8u3ce66ragytu45kcmd9asj3u with 1000000uluna"
    )
  })
  ...
  test("Execute contract without coins", () => {
    ...
    expect(readMsg(msg)).toBe(
      "Execute send on xpla10llyp6v3j3her8u3ce66ragytu45kcmd9asj3u"
    )
  })
})
...
test("Decimal", () => {
  ...
  expect(readMsg(msg)).toBe(
    "Send 1234560uluna to xpla17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp"
  )
})
...
test("Transfer IBC token", () => {
  ...
  expect(readMsg(msg)).toBe(
    "Send 1000000uluna to xpla17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp via channel"
  )
})
