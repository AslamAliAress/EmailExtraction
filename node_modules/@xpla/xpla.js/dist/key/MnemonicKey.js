...
var MnemonicKey = /** @class */ (function (_super) {
    ...
    function MnemonicKey(options) {
        ...
        var hdPathXpla = "m/44'/".concat(coinType, "'/").concat(account, "'/0/").concat(index);
        var xplaHD = masterKey.derivePath(hdPathXpla);
        var privateKey = xplaHD.privateKey;
        if (!privateKey) {
