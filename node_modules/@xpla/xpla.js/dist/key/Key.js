...
var Key = /** @class */ (function () {
     ...
     */
    function Key(publicKey, evm) {
        if (evm === void 0) { evm = false; }
    ...
    Object.defineProperty(Key.prototype, "eip55Address", {
        get: function () {
            if (!this.publicKey) {
    ...
    Object.defineProperty(Key.prototype, "bech32Address", {
        get: function () {
            if (!this.publicKey) {
                throw new Error('Could not compute accAddress: missing rawAddress');
            }
    ...
    Object.defineProperty(Key.prototype, "valAddress", {
        ...
        get: function () {
            ...
            return bech32_1.bech32.encode('xplavaloper', bech32_1.bech32.toWords(this.publicKey.rawAddress()));
        },
        enumerable: false,
        configurable: true
    });
     ...
     * @param isClassic target network is isClassic or not?
     */
    Key.prototype.createSignatureWithSigners = function (signDoc, signers, isClassic) {
        return __awaiter(this, void 0, void 0, function () {
            var signerInfos, sigBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @param tx
     */
    Key.prototype.signTxWithSigners = function (tx, signers, accountNumber, chainID, isClassic) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var this_signer, i, copyTx, sign_doc, signature, sigData, i;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (this_signer < 0) {
                            throw new Error('Signature could not be created: this key missing in signers');
                        }
                        copyTx = new core_1.Tx(tx.body, new core_1.AuthInfo([], tx.auth_info.fee), []);
                        sign_doc = new core_1.SignDoc(chainID, accountNumber, signers[this_signer].sequence, copyTx.auth_info, copyTx.body);
                        if (!(signers[this_signer].mode_info.single &&
                            signers[this_signer].mode_info.single.mode ===
                                signing_1.SignMode.SIGN_MODE_LEGACY_AMINO_JSON)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createSignatureAmino(sign_doc, isClassic)];
                    case 1:
                        signature = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.createSignatureWithSigners(sign_doc, signers, isClassic)];
                    case 3:
                        signature = _b.sent();
                        _b.label = 4;
                    case 4:
                        ...
                        for (i = 0; i < signers.length; ++i) {
                            if (i === this_signer) {
                                ...
                                copyTx.signatures.push((_a = tx.signatures[i]) !== null && _a !== void 0 ? _a : '');
                            }
                        }
