...
import { AccAddress, EvmAddress, ValAddress, Tx, SignDoc, SignerInfo, PublicKey } from '../core';
...
export declare abstract class Key {
     ...
     */
    get accAddress(): AccAddress | EvmAddress | string;
    get eip55Address(): EvmAddress;
    get bech32Address(): AccAddress;
    /**
     ...
     */
    constructor(publicKey?: PublicKey | undefined, evm?: boolean);
    /**
     ...
     * @param isClassic target network is isClassic or not?
     */
    createSignatureWithSigners(signDoc: SignDoc, signers: SignerInfo[], isClassic?: boolean): Promise<SignatureV2>;
    /**
     ...
     * @param tx
     */
    signTxWithSigners(tx: Tx, signers: SignerInfo[], accountNumber: number, chainID: string, isClassic?: boolean): Promise<Tx>;
}
