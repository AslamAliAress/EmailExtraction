...
var AuthAPI = /** @class */ (function (_super) {
    ...
    AuthAPI.prototype.moduleAccount = function (name, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.c.get("/cosmos/auth/v1beta1/module_accounts/".concat(name), params)];
                    case 1:
                        account = (_a.sent()).account;
    ...
    AuthAPI.prototype.moduleAccounts = function (params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var accounts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.c.get('/cosmos/auth/v1beta1/module_accounts', params)];
                    case 1:
                        accounts = (_a.sent()).accounts;
                        return [2 /*return*/, accounts.map(function (acc) { return core_1.ModuleAccount.fromData(acc); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        ...
                        .then(function (_a) {
                        var d = _a.params;
                        return core_1.AuthParamsV1B1.fromData(d);
                    })];
            });
        });
    };
