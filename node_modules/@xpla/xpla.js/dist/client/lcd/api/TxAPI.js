...
var msgs_1 = require("../../../client/ecd/msgs");
...
var TxAPI = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        if (Array.isArray(msgs)) {
                            if (msgs.length < 1 || msgs[0] instanceof msgs_1.EvmMessage) {
                                return [2 /*return*/, new core_1.Tx(new core_1.TxBody([], memo !== null && memo !== void 0 ? memo : '', timeoutHeight !== null && timeoutHeight !== void 0 ? timeoutHeight : 0), new core_1.AuthInfo([], fee), [])];
                            }
                        }
                        return [2 /*return*/, new core_1.Tx(new core_1.TxBody(msgs, memo !== null && memo !== void 0 ? memo : '', timeoutHeight !== null && timeoutHeight !== void 0 ? timeoutHeight : 0), new core_1.AuthInfo([], fee), [])];
                }
            });
        });
    };
    ...
    TxAPI.prototype.estimateFee = function (signers, options) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var gasPrices, gasAdjustment, feeDenoms, msgs, gas, gasPricesCoins, gasPricesCoinsFiltered, txBody, authInfo, tx, feeAmount;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        gasPrices = (_a = options.gasPrices) !== null && _a !== void 0 ? _a : this.lcd.config.gasPrices;
                        gasAdjustment = (_b = options.gasAdjustment) !== null && _b !== void 0 ? _b : this.lcd.config.gasAdjustment;
                        feeDenoms = (_c = options.feeDenoms) !== null && _c !== void 0 ? _c : [
                        ...
                        if (Array.isArray(msgs)) {
                            if (msgs.length < 1 || msgs[0] instanceof msgs_1.EvmMessage) {
                                return [2 /*return*/, new core_1.Fee(0, '0axpla', '', '')];
                            }
                        }
                        txBody = new core_1.TxBody(msgs, (_d = options.memo) !== null && _d !== void 0 ? _d : '');
    ...
    TxAPI.prototype.estimateGas = function (tx, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        gasAdjustment = (_a = options === null || options === void 0 ? void 0 : options.gasAdjustment) !== null && _a !== void 0 ? _a : this.lcd.config.gasAdjustment;
                        simTx = tx;
                        if (tx.signatures.length <= 0) {
                            if (!((options === null || options === void 0 ? void 0 : options.signers) && options.signers.length > 0)) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        txResponse = (_b.sent()).tx_response;
                    ...
                    case 9:
                        ...
                        return [2 /*return*/, {
                                ...
                                logs: ((_a = txInfo.logs) !== null && _a !== void 0 ? _a : []).map(function (l) { return core_1.TxLog.fromData(l); }),
                                code: txInfo.code,
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this._broadcast(tx, 'BROADCAST_MODE_BLOCK').then(function (_a) {
                        ...
                        var blockResult = {
                            ...
                            height: +d.height,
                            logs: d.logs.map(function (l) { return core_1.TxLog.fromData(l); }),
                            code: d.code,
