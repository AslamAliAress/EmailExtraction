...
var staking_1 = require("../../../core/staking");
            ...
            return __generator(this, function (_a) {
                if (delegator !== undefined && validator !== undefined) {
                    return [2 /*return*/, this.c
                            ...
                            return [
                                [staking_1.Delegation.fromData(data)],
                                { total: 1, next_key: '' },
                            ];
                        })];
                }
                    ...
                    return [2 /*return*/, this.c
                            ...
                            data.delegation_responses.map(staking_1.Delegation.fromData),
                            data.pagination,
                        ]; })];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        ...
                        d.redelegation_responses.map(staking_1.Redelegation.fromData),
                        d.pagination,
                    ]; })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) { return [d.validators.map(staking_1.Validator.fromData), d.pagination]; })];
            });
        });
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) { return staking_1.Validator.fromData(d.validator); })];
            });
        });
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        ...
                        var d = _a.pool;
                        return ({
                            bonded_tokens: new core_1.Coin('axpla', d.bonded_tokens),
                            not_bonded_tokens: new core_1.Coin('axpla', d.not_bonded_tokens),
                        });
                    })];
            });
        });
