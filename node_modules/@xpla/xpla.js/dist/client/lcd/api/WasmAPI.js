...
var WasmAPI = /** @class */ (function (_super) {
    ...
    WasmAPI.prototype.contractInfo = function (contractAddress, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, historyEntry, _, endpoint;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.c
                                ...
                                return ({
                                    ...
                                    created: d.created ? wasm_1.AbsoluteTxPosition.fromData(d.created) : undefined,
    ...
    WasmAPI.prototype.parameters = function (module, params) {
        if (module === void 0) { module = 'codes'; }
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmwasm/wasm/v1/".concat(module, "/params"), params)
                        .then(function (_a) {
                        var d = _a.params;
                        if (module === 'codes')
                            return wasm_1.CodesParamsV1.fromData(d);
                        return d;
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) { return [
                        d.entries.map(function (entry) { return wasm_1.HistoryEntry.fromData(entry); }),
                        d.pagination,
                    ]; })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) { return [
                        d.code_infos.map(function (codeInfo) {
                            return {
