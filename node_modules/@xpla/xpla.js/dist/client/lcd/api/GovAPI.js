...
var GovAPI = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmos/gov/v1/proposals", params)
                        .then(function (d) { return [
                        d.proposals.map(function (prop) {
                            return core_1.ProposalV1.fromData(prop, _this.lcd.config.isClassic);
                        }),
                        d.pagination,
                    ]; })];
            });
    ...
    GovAPI.prototype.proposal = function (proposalId, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmos/gov/v1/proposals/".concat(proposalId), params)
                        .then(function (d) { return core_1.ProposalV1.fromData(d.proposal); })];
            });
        });
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        creationTx = _a.sent();
                        msg = creationTx.body.messages.find(function (msg) { return msg['@type'] === '/cosmos.gov.v1.MsgSubmitProposal'; });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (proposal.status === gov_1.ProposalStatus.PROPOSAL_STATUS_DEPOSIT_PERIOD ||
                            ...
                            return [2 /*return*/, this.c
                                    .get("/cosmos/gov/v1/proposals/".concat(proposalId, "/deposits"), _params)
                                    .then(function (d) { return [
                        ...
                        return [2 /*return*/, this.c
                                ...
                                d.txs.map(function (tx) {
                                    return tx.body.messages.forEach(function (msg) {
                                        if (msg['@type'] === '/cosmos.gov.v1.MsgDeposit' &&
    ...
    GovAPI.prototype.searchProposalCreationTx = function (proposalId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                params = new URLSearchParams();
                params.append('events', "message.action='/cosmos.gov.v1.MsgSubmitProposal'");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (proposal.status === gov_1.ProposalStatus.PROPOSAL_STATUS_DEPOSIT_PERIOD) {
                            return [2 /*return*/, this.c
                                    .get("/cosmos/gov/v1/proposals/".concat(proposalId, "/votes"), _params)
                                    .then(function (d) { return [d.votes.map(function (v) { return core_1.VoteV1.fromData(v); }), d.pagination]; })];
                        }
                        params = new URLSearchParams();
                        ...
                        return [2 /*return*/, this.c
                                ...
                                d.txs.map(function (tx) {
                                    return tx.body.messages.forEach(function (msg) {
                                        if (msg['@type'] === '/cosmos.gov.v1.MsgVote' &&
                                            Number.parseInt(msg.proposal_id) == proposalId) {
                                            votes.push(new core_1.VoteV1(proposalId, msg.voter, [new core_1.WeightedVoteOptionV1(msg.option, '1')], msg.metadata));
                                        }
                                        else if (msg['@type'] === '/cosmos.gov.v1.MsgVoteWeighted' &&
                                            Number.parseInt(msg.proposal_id) == proposalId) {
                                            votes.push(new core_1.VoteV1(proposalId, msg.voter, msg.options.map(function (o) {
                                                return core_1.WeightedVoteOptionV1.fromData(o);
                                            }), msg.metadata));
                                        }
                                    }, votes);
                                });
    ...
    GovAPI.prototype.tally = function (proposalId, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmos/gov/v1/proposals/".concat(proposalId, "/tally"), params)
                        .then(function (_a) {
                        var d = _a.tally;
                        return ({
                            yes: new core_1.Int(d.yes_count),
                            no: new core_1.Int(d.no_count),
                            no_with_veto: new core_1.Int(d.no_with_veto_count),
                            abstain: new core_1.Int(d.abstain_count),
                        });
                    })];
            });
        });
    ...
    GovAPI.prototype.parameters = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmos/gov/v1/params/deposit", params)
                        .then(function (_a) {
                        var d = _a.params;
                        return core_1.GovParamsV1.fromData(d);
                    })];
            });
        });
    };
    ...
    GovAPI.prototype.depositParameters = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.parameters(params)];
                    case 1:
                        govparams = _c.sent();
                        return [2 /*return*/, {
                                max_deposit_period: (_b = (_a = govparams.max_deposit_period) === null || _a === void 0 ? void 0 : _a.seconds.toNumber()) !== null && _b !== void 0 ? _b : 0,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        govparams = _c.sent();
                        return [2 /*return*/, {
                                voting_period: (_b = (_a = govparams.voting_period) === null || _a === void 0 ? void 0 : _a.seconds.toNumber()) !== null && _b !== void 0 ? _b : 0,
                            }];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        govparams = _a.sent();
                        return [2 /*return*/, {
                                quorum: new core_1.Dec(govparams.quorum),
                                veto_threshold: new core_1.Dec(govparams.veto_threshold),
                                threshold: new core_1.Dec(govparams.threshold),
                            }];
                }
            });
        });
