...
var service_1 = require("@xpla/xpla.proto/cosmos/tx/v1beta1/service");
...
var APIRequester = /** @class */ (function () {
    ...
    APIRequester.prototype.computeEndpointFrom = function (base, endpoint) {
    ...
    APIRequester.prototype.getFcd = function (endpoint, params, fcdURL) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                url = this.computeEndpointFrom(fcdURL !== null && fcdURL !== void 0 ? fcdURL : this.baseURL.replace('lcd', 'fcd'), endpoint);
                return [2 /*return*/, this.axios.get(url, { params: params }).then(function (d) { return d.data; })];
            });
        });
    };
