...
exports.EvmAuthAPI = void 0;
var BaseAPI_1 = require("./BaseAPI");
var core_1 = require("../../../core");
var EvmAuthAPI = /** @class */ (function (_super) {
    __extends(EvmAuthAPI, _super);
    function EvmAuthAPI(ecd) {
     ...
     */
    EvmAuthAPI.prototype.accountInfo = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var account;
            var _this = this;
            return __generator(this, function (_a) {
                account = new core_1.EvmAccount(address, 0);
                return [2 /*return*/, this.e
                        ...
                        return new core_1.EvmAccount(address, core_1.Numeric.parse(response.result).toNumber());
                    })];
            });
        });
    };
