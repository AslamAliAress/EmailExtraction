...
var keys_1 = require("@xpla/xpla.proto/cosmos/crypto/multisig/keys");
var any_1 = require("@xpla/xpla.proto/google/protobuf/any");
var keys_2 = require("@xpla/xpla.proto/cosmos/crypto/secp256k1/keys");
var keys_3 = require("@xpla/xpla.proto/cosmos/crypto/ed25519/keys");
...
var SimplePublicKey = /** @class */ (function (_super) {
    ...
    SimplePublicKey.prototype.rawAddress = function () {
        ...
        var x1 = (0, keccak256_1.keccak256)((0, bytes_1.hexDataSlice)(x0, 1));
        var x2 = (0, bytes_1.hexDataSlice)(x1, 12);
        return Buffer.from(stripHexPrefix(x2), 'hex');
    };
    SimplePublicKey.prototype.address = function () {
        return bech32_1.bech32.encode('xpla', bech32_1.bech32.toWords(this.rawAddress()));
    };
    SimplePublicKey.prototype.pubkeyAddress = function () {
        return bech32_1.bech32.encode('xplapub', bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
    SimplePublicKey.prototype.evmAddress = function () {
        return (0, eip55_1.encode)('0x' + Buffer.from(this.rawAddress()).toString('hex'));
    };
...
var LegacyAminoMultisigPublicKey = /** @class */ (function (_super) {
    ...
    LegacyAminoMultisigPublicKey.prototype.evmAddress = function () {
        return (0, eip55_1.encode)('0x' + Buffer.from(this.rawAddress()).toString('hex'));
    };
...
var ValConsPublicKey = /** @class */ (function (_super) {
    ...
    ValConsPublicKey.prototype.address = function () {
        return bech32_1.bech32.encode('xplavalcons', bech32_1.bech32.toWords(this.rawAddress()));
    };
    ValConsPublicKey.prototype.pubkeyAddress = function () {
        return bech32_1.bech32.encode('xplavalconspub', bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
    ValConsPublicKey.prototype.evmAddress = function () {
        return (0, eip55_1.encode)('0x' + Buffer.from(this.rawAddress()).toString('hex'));
    };
