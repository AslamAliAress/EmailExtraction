...
var signing_1 = require("@xpla/xpla.proto/cosmos/tx/signing/v1beta1/signing");
...
var Tx = /** @class */ (function () {
    ...
    Tx.fromAmino = function (data, isClassic) {
        ...
        return new Tx(new TxBody(data.value.msg.map(function (m) { return Msg_1.Msg.fromAmino(m, isClassic); }), data.value.memo, Number.parseInt(data.value.timeout_height)), new AuthInfo([], Fee_1.Fee.fromAmino(data.value.fee)), signatures.map(function (s) { var _a, _b; return (_b = (_a = s.data.single) === null || _a === void 0 ? void 0 : _a.signature) !== null && _b !== void 0 ? _b : ''; }));
    };
    ...
    Tx.prototype.appendEmptySignatures = function (signers) {
        ...
        signers.forEach(function (signer) {
            ...
            _this.signatures.push(' '.repeat(90));
        });
    };
...
var TxBody = /** @class */ (function () {
    ...
    TxBody.prototype.toProto = function (isClassic) {
        ...
        return tx_1.TxBody.fromPartial({
            ...
            timeoutHeight: (_a = this.timeout_height) !== null && _a !== void 0 ? _a : 0,
        });
    };
...
var AuthInfo = /** @class */ (function () {
    function AuthInfo(signer_infos, fee, tip) {
        this.signer_infos = signer_infos;
        this.fee = fee;
        this.tip = tip;
    }
    AuthInfo.fromData = function (data) {
        return new AuthInfo(data.signer_infos.map(function (s) { return SignerInfo.fromData(s); }), data.fee ? Fee_1.Fee.fromData(data.fee) : undefined, data.tip ? Tip_1.Tip.fromData(data.tip) : undefined);
    };
    AuthInfo.prototype.toData = function () {
        var _a = this, signer_infos = _a.signer_infos, fee = _a.fee, tip = _a.tip;
        return {
            signer_infos: signer_infos.map(function (info) { return info.toData(); }),
            fee: fee ? fee.toData() : undefined,
            tip: tip ? tip.toData() : undefined,
        };
    };
    AuthInfo.fromProto = function (proto) {
        return new AuthInfo(proto.signerInfos.map(function (s) { return SignerInfo.fromProto(s); }), proto.fee ? Fee_1.Fee.fromProto(proto.fee) : undefined, proto.tip ? Tip_1.Tip.fromProto(proto.tip) : undefined);
    };
    AuthInfo.prototype.toProto = function () {
        var _a = this, signer_infos = _a.signer_infos, fee = _a.fee, tip = _a.tip;
        return tx_1.AuthInfo.fromPartial({
            signerInfos: signer_infos.map(function (info) { return info.toProto(); }),
