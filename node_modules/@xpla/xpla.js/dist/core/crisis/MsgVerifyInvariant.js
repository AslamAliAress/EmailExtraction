...
var tx_1 = require("@xpla/xpla.proto/cosmos/crisis/v1beta1/tx");
/**
...
var MsgVerifyInvariant = /** @class */ (function (_super) {
    ...
    MsgVerifyInvariant.fromAmino = function (data, _isClassic) {
    ...
    MsgVerifyInvariant.prototype.toAmino = function (_isClassic) {
        throw new Error('MsgVerifyInvarant is not allowed to send');
    };
    MsgVerifyInvariant.fromData = function (data, _isClassic) {
        var sender = data.sender, invariantModuleName = data.invariantModuleName, invariantRoute = data.invariantRoute;
        return new MsgVerifyInvariant(sender, invariantModuleName, invariantRoute);
    };
    MsgVerifyInvariant.prototype.toData = function (_isClassic) {
    ...
    MsgVerifyInvariant.fromProto = function (proto, _isClassic) {
        return new MsgVerifyInvariant(proto.sender, proto.invariantModuleName, proto.invariantRoute);
    };
    MsgVerifyInvariant.prototype.toProto = function (_isClassic) {
        throw new Error('MsgVerifyInvarant is not allowed to send');
    };
