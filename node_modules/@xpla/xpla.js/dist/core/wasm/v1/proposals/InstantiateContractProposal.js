...
var proposal_legacy_1 = require("@xpla/xpla.proto/cosmwasm/wasm/v1/proposal_legacy");
/**
...
var InstantiateContractProposal = /** @class */ (function (_super) {
    ...
    InstantiateContractProposal.prototype.toProto = function (isClassic) {
        ...
        return proposal_legacy_1.InstantiateContractProposal.fromPartial({
            title: title,
            description: description,
            runAs: run_as,
            admin: admin,
    ...
    InstantiateContractProposal.prototype.packAny = function (isClassic) {
        ...
        return any_1.Any.fromPartial({
            ...
            value: proposal_legacy_1.InstantiateContractProposal.encode(this.toProto(isClassic)).finish(),
        });
    };
    InstantiateContractProposal.unpackAny = function (msgAny, isClassic) {
        ...
        return InstantiateContractProposal.fromProto(proposal_legacy_1.InstantiateContractProposal.decode(msgAny.value), isClassic);
    };
    InstantiateContractProposal.fromData = function (data, isClassic) {
        if (isClassic) {
            throw new Error('Not supported for the network');
        }
        var title = data.title, description = data.description, run_as = data.run_as, admin = data.admin, code_id = data.code_id, label = data.label, msg = data.msg, funds = data.funds;
