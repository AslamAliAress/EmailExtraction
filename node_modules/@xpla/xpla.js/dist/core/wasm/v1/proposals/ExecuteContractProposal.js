...
var ExecuteContractProposal = /** @class */ (function (_super) {
    ...
    ExecuteContractProposal.prototype.toProto = function (isClassic) {
        ...
        if (isClassic) {
            ...
            return proposal_legacy_1.ExecuteContractProposal.fromPartial({
                title: title,
                description: description,
                funds: coins.toProto(),
                contract: contract,
    ...
    ExecuteContractProposal.prototype.packAny = function (isClassic) {
        if (isClassic) {
            ...
            return any_1.Any.fromPartial({
                ...
                value: proposal_legacy_1.ExecuteContractProposal.encode(this.toProto(isClassic)).finish(),
            });
        }
    };
    ExecuteContractProposal.unpackAny = function (msgAny, isClassic) {
        return ExecuteContractProposal.fromProto(proposal_legacy_1.ExecuteContractProposal.decode(msgAny.value), isClassic);
    };
    ExecuteContractProposal.fromData = function (data, isClassic) {
        if (isClassic) {
            throw new Error('Not supported for the network');
        }
        var title = data.title, description = data.description, run_as = data.run_as, contract = data.contract, msg = data.msg, funds = data.funds;
