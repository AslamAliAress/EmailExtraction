...
import { StakeAuthorization as StakeAuthorization_pb, AuthorizationType, StakeAuthorization_Validators as StakeAuthorizationValidators_pb } from '@xpla/xpla.proto/cosmos/staking/v1beta1/authz';
...
export declare class StakeAuthorization extends JSONSerializable<any, StakeAuthorization.Data, StakeAuthorization.Proto> {
    ...
    static fromAmino(_data: any, _isClassic?: boolean): StakeAuthorizationValidators;
    toAmino(_isClassic?: boolean): any;
...
export declare class StakeAuthorizationValidators extends JSONSerializable<any, StakeAuthorizationValidators.Data, StakeAuthorizationValidators.Proto> {
    ...
    static fromAmino(_data: any, _isClassic?: boolean): StakeAuthorizationValidators;
    toAmino(_isClassic?: boolean): any;
    static fromData(data: StakeAuthorizationValidators.Data, _isClassic?: boolean): StakeAuthorizationValidators;
    toData(_isClassic?: boolean): StakeAuthorizationValidators.Data;
    static fromProto(proto: StakeAuthorizationValidators.Proto, _isClassic?: boolean): StakeAuthorizationValidators;
    toProto(_isClassic?: boolean): StakeAuthorizationValidators.Proto;
}
