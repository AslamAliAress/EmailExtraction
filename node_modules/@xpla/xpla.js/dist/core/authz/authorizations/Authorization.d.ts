...
export declare class AuthorizationGrant extends JSONSerializable<AuthorizationGrant.Amino, AuthorizationGrant.Data, AuthorizationGrant.Proto> {
    ...
    grantee: AccAddress | undefined;
    constructor(authorization: Authorization, expiration: Date, granter: AccAddress | undefined, grantee: AccAddress | undefined);
    static fromAmino(data: AuthorizationGrant.Amino, isClassic?: boolean): AuthorizationGrant;
