...
var authz_1 = require("@xpla/xpla.proto/cosmos/bank/v1beta1/authz");
...
var SendAuthorization = /** @class */ (function (_super) {
    ...
    SendAuthorization.fromAmino = function (data, _isClassic) {
    ...
    SendAuthorization.fromData = function (data, _isClassic) {
        return new SendAuthorization(Coins_1.Coins.fromData(data.spend_limit));
    };
    SendAuthorization.prototype.toData = function (_isClassic) {
        var spend_limit = this.spend_limit;
        return {
    ...
    SendAuthorization.fromProto = function (proto, _isClassic) {
        return new SendAuthorization(Coins_1.Coins.fromProto(proto.spendLimit));
    };
    SendAuthorization.prototype.toProto = function (_isClassic) {
