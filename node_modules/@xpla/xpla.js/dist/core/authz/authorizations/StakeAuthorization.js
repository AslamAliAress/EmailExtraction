...
var authz_1 = require("@xpla/xpla.proto/cosmos/staking/v1beta1/authz");
...
var StakeAuthorization = /** @class */ (function (_super) {
    ...
    StakeAuthorization.fromAmino = function (_data, _isClassic) {
        throw new Error('Amino not supported');
    };
    StakeAuthorization.prototype.toAmino = function (_isClassic) {
        throw new Error('Amino not supported');
    };
...
var StakeAuthorizationValidators = /** @class */ (function (_super) {
    ...
    StakeAuthorizationValidators.fromAmino = function (_data, _isClassic) {
        throw new Error('Amino not supported');
    };
    StakeAuthorizationValidators.prototype.toAmino = function (_isClassic) {
        throw new Error('Amino not supported');
    };
    StakeAuthorizationValidators.fromData = function (data, _isClassic) {
        return new StakeAuthorizationValidators(data.address);
    };
    StakeAuthorizationValidators.prototype.toData = function (_isClassic) {
        return {
            address: this.address,
        };
    };
    StakeAuthorizationValidators.fromProto = function (proto, _isClassic) {
        return new StakeAuthorizationValidators(proto.address);
    };
    StakeAuthorizationValidators.prototype.toProto = function (_isClassic) {
