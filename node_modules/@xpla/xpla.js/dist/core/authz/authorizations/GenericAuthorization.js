...
var authz_1 = require("@xpla/xpla.proto/cosmos/authz/v1beta1/authz");
...
var GenericAuthorization = /** @class */ (function (_super) {
    ...
    GenericAuthorization.fromAmino = function (data, _isClassic) {
    ...
    GenericAuthorization.fromData = function (data, _isClassic) {
        return new GenericAuthorization(data.msg);
    };
    GenericAuthorization.prototype.toData = function (_isClassic) {
        var msg = this.msg;
        return {
    ...
    GenericAuthorization.fromProto = function (data, _isClassic) {
        return new GenericAuthorization(data.msg);
    };
    GenericAuthorization.prototype.toProto = function (_isClassic) {
