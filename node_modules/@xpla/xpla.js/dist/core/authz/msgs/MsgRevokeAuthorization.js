...
var tx_1 = require("@xpla/xpla.proto/cosmos/authz/v1beta1/tx");
...
var MsgRevokeAuthorization = /** @class */ (function (_super) {
    ...
    MsgRevokeAuthorization.fromAmino = function (data, _isClassic) {
    ...
    MsgRevokeAuthorization.fromData = function (data, _isClassic) {
        var granter = data.granter, grantee = data.grantee, msg_type_url = data.msg_type_url;
        return new MsgRevokeAuthorization(granter, grantee, msg_type_url);
    };
    MsgRevokeAuthorization.prototype.toData = function (_isClassic) {
        var _a = this, granter = _a.granter, grantee = _a.grantee, msg_type_url = _a.msg_type_url;
        return {
    ...
    MsgRevokeAuthorization.fromProto = function (proto, _isClassic) {
        return new MsgRevokeAuthorization(proto.granter, proto.grantee, proto.msgTypeUrl);
    };
    MsgRevokeAuthorization.prototype.toProto = function (_isClassic) {
        var _a = this, granter = _a.granter, grantee = _a.grantee, msg_type_url = _a.msg_type_url;
