...
export declare class MsgRevokeAuthorization extends JSONSerializable<MsgRevokeAuthorization.Amino, MsgRevokeAuthorization.Data, MsgRevokeAuthorization.Proto> {
    ...
    static fromAmino(data: MsgRevokeAuthorization.Amino, _isClassic?: boolean): MsgRevokeAuthorization;
    toAmino(isClassic?: boolean): MsgRevokeAuthorization.Amino;
    static fromData(data: MsgRevokeAuthorization.Data, _isClassic?: boolean): MsgRevokeAuthorization;
    toData(_isClassic?: boolean): MsgRevokeAuthorization.Data;
    static fromProto(proto: MsgRevokeAuthorization.Proto, _isClassic?: boolean): MsgRevokeAuthorization;
    toProto(_isClassic?: boolean): MsgRevokeAuthorization.Proto;
