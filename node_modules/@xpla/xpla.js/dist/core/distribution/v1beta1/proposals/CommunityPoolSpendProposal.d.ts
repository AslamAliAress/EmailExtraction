...
export declare class CommunityPoolSpendProposal extends JSONSerializable<CommunityPoolSpendProposal.Amino, CommunityPoolSpendProposal.Data, CommunityPoolSpendProposal.Proto> {
    ...
    static fromAmino(data: CommunityPoolSpendProposal.Amino, _isClassic?: boolean): CommunityPoolSpendProposal;
    toAmino(isClassic?: boolean): CommunityPoolSpendProposal.Amino;
    static fromData(data: CommunityPoolSpendProposal.Data, _isClassic?: boolean): CommunityPoolSpendProposal;
    toData(_isClassic?: boolean): CommunityPoolSpendProposal.Data;
    static fromProto(proto: CommunityPoolSpendProposal.Proto, _isClassic?: boolean): CommunityPoolSpendProposal;
    toProto(_isClassic?: boolean): CommunityPoolSpendProposal.Proto;
