...
var distribution_1 = require("@xpla/xpla.proto/cosmos/distribution/v1beta1/distribution");
/**
...
var CommunityPoolSpendProposal = /** @class */ (function (_super) {
    ...
    CommunityPoolSpendProposal.fromAmino = function (data, _isClassic) {
    ...
    CommunityPoolSpendProposal.fromData = function (data, _isClassic) {
    ...
    CommunityPoolSpendProposal.prototype.toData = function (_isClassic) {
        var _a = this, title = _a.title, description = _a.description, recipient = _a.recipient, amount = _a.amount;
        return {
    ...
    CommunityPoolSpendProposal.fromProto = function (proto, _isClassic) {
        return new CommunityPoolSpendProposal(proto.title, proto.description, proto.recipient, Coins_1.Coins.fromProto(proto.amount));
    };
    CommunityPoolSpendProposal.prototype.toProto = function (_isClassic) {
        var _a = this, title = _a.title, description = _a.description, recipient = _a.recipient, amount = _a.amount;
