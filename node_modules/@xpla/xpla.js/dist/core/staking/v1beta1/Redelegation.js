...
exports.RedelegationV1B1 = void 0;
 ...
 */
var RedelegationV1B1 = /** @class */ (function (_super) {
    __extends(RedelegationV1B1, _super);
    /**
     *
     ...
     */
    function RedelegationV1B1(delegator_address, validator_src_address, validator_dst_address, entries) {
    ...
    RedelegationV1B1.fromAmino = function (data) {
        ...
        return new RedelegationV1B1(delegator_address, validator_src_address, validator_dst_address, entries.map(function (e) { return RedelegationV1B1.Entry.fromAmino(e); }));
    };
    RedelegationV1B1.prototype.toAmino = function () {
    ...
    RedelegationV1B1.fromData = function (data) {
        var _a = data.redelegation, delegator_address = _a.delegator_address, validator_src_address = _a.validator_src_address, validator_dst_address = _a.validator_dst_address, entries = data.entries;
        return new RedelegationV1B1(delegator_address, validator_src_address, validator_dst_address, entries.map(function (e) { return RedelegationV1B1.Entry.fromData(e); }));
    };
    RedelegationV1B1.prototype.toData = function () {
        var _a = this, delegator_address = _a.delegator_address, validator_src_address = _a.validator_src_address, validator_dst_address = _a.validator_dst_address, entries = _a.entries;
        return {
            redelegation: {
                delegator_address: delegator_address,
    ...
    RedelegationV1B1.fromProto = function (data) {
        var redelegationProto = data.redelegation;
        return new RedelegationV1B1(redelegationProto.delegatorAddress, redelegationProto.validatorDstAddress, redelegationProto.validatorDstAddress, data.entries.map(function (e) { return RedelegationV1B1.Entry.fromProto(e); }));
    };
    RedelegationV1B1.prototype.toProto = function () {
        var _a = this, delegator_address = _a.delegator_address, validator_src_address = _a.validator_src_address, validator_dst_address = _a.validator_dst_address, entries = _a.entries;
    ...
    return RedelegationV1B1;
}(json_1.JSONSerializable));
exports.RedelegationV1B1 = RedelegationV1B1;
(function (RedelegationV1B1) {
    ...
    RedelegationV1B1.Entry = Entry;
})(RedelegationV1B1 = exports.RedelegationV1B1 || (exports.RedelegationV1B1 = {}));
exports.RedelegationV1B1 = RedelegationV1B1;
