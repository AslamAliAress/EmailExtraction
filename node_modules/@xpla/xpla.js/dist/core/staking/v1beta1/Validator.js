 ...
 * in [[StakingAPI]].
 */
var ValidatorV1B1 = /** @class */ (function (_super) {
    __extends(ValidatorV1B1, _super);
    /**
     *
     ...
     */
    function ValidatorV1B1(operator_address, consensus_pubkey, jailed, status, tokens, delegator_shares, description, unbonding_height, unbonding_time, commission, min_self_delegation) {
    ...
    ValidatorV1B1.prototype.toAmino = function () {
        return {
    ...
    ValidatorV1B1.fromAmino = function (data) {
        return new ValidatorV1B1(data.operator_address, PublicKey_1.ValConsPublicKey.fromAmino(data.consensus_pubkey), data.jailed || false, data.status || 0, new numeric_1.Int(data.tokens), new numeric_1.Dec(data.delegator_shares), ValidatorV1B1.Description.fromAmino(data.description), Number.parseInt(data.unbonding_height), new Date(data.unbonding_time), ValidatorV1B1.Commission.fromAmino(data.commission), new numeric_1.Int(data.min_self_delegation));
    };
    ValidatorV1B1.prototype.toData = function () {
        return {
            operator_address: this.operator_address,
    ...
    ValidatorV1B1.fromData = function (data) {
        return new ValidatorV1B1(data.operator_address, PublicKey_1.ValConsPublicKey.fromData(data.consensus_pubkey), data.jailed || false, data.status || 0, new numeric_1.Int(data.tokens), new numeric_1.Dec(data.delegator_shares), ValidatorV1B1.Description.fromData(data.description), Number.parseInt(data.unbonding_height), new Date(data.unbonding_time), ValidatorV1B1.Commission.fromData(data.commission), new numeric_1.Int(data.min_self_delegation));
    };
    ValidatorV1B1.prototype.toProto = function () {
    ...
    ValidatorV1B1.fromProto = function (data) {
        return new ValidatorV1B1(data.operatorAddress, PublicKey_1.ValConsPublicKey.unpackAny(data.consensusPubkey), data.jailed, data.status, new numeric_1.Int(data.tokens), new numeric_1.Dec(data.delegatorShares), ValidatorV1B1.Description.fromProto(data.description), data.unbondingHeight.toNumber(), data.unbondingTime, ValidatorV1B1.Commission.fromProto(data.commission), new numeric_1.Int(data.minSelfDelegation));
    };
    return ValidatorV1B1;
}(json_1.JSONSerializable));
exports.ValidatorV1B1 = ValidatorV1B1;
(function (ValidatorV1B1) {
    ValidatorV1B1.Status = staking_1.BondStatus;
    ...
    ValidatorV1B1.Description = Description;
    ...
    ValidatorV1B1.CommissionRates = CommissionRates;
    ...
    ValidatorV1B1.Commission = Commission;
})(ValidatorV1B1 = exports.ValidatorV1B1 || (exports.ValidatorV1B1 = {}));
exports.ValidatorV1B1 = ValidatorV1B1;
