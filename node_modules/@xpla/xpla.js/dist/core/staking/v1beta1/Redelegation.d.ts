...
import { RedelegationResponse as RedelegationResponseV1B1_pb, RedelegationEntryResponse as RedelegationEntryResponseV1B1_pb } from '@xpla/xpla.proto/cosmos/staking/v1beta1/staking';
/**
 ...
 */
export declare class RedelegationV1B1 extends JSONSerializable<RedelegationV1B1.Amino, RedelegationV1B1.Data, RedelegationV1B1.Proto> {
    delegator_address: AccAddress;
    validator_src_address: ValAddress;
    validator_dst_address: ValAddress;
    entries: RedelegationV1B1.Entry[];
    /**
     *
     ...
     */
    constructor(delegator_address: AccAddress, validator_src_address: ValAddress, validator_dst_address: ValAddress, entries: RedelegationV1B1.Entry[]);
    static fromAmino(data: RedelegationV1B1.Amino): RedelegationV1B1;
    toAmino(): RedelegationV1B1.Amino;
    static fromData(data: RedelegationV1B1.Data): RedelegationV1B1;
    toData(): RedelegationV1B1.Data;
    static fromProto(data: RedelegationV1B1.Proto): RedelegationV1B1;
    toProto(): RedelegationV1B1.Proto;
}
export declare namespace RedelegationV1B1 {
    interface Amino {
        redelegation: {
            delegator_address: AccAddress;
            validator_src_address: ValAddress;
    ...
    type Proto = RedelegationResponseV1B1_pb;
    ...
    namespace Entry {
        ...
        type Proto = RedelegationEntryResponseV1B1_pb;
    }
}
