...
var tx_1 = require("@xpla/xpla.proto/ibc/applications/transfer/v1/tx");
/**
...
var MsgTransfer = /** @class */ (function (_super) {
    ...
    MsgTransfer.prototype.toProto = function (_) {
        var _a;
        var _b = this, source_port = _b.source_port, source_channel = _b.source_channel, token = _b.token, sender = _b.sender, receiver = _b.receiver, timeout_height = _b.timeout_height, timeout_timestamp = _b.timeout_timestamp;
        return tx_1.MsgTransfer.fromPartial({
            ...
            timeoutTimestamp: (_a = timeout_timestamp === null || timeout_timestamp === void 0 ? void 0 : timeout_timestamp.toFixed()) !== null && _a !== void 0 ? _a : '0',
        });
    };
