...
var types_1 = require("@xpla/xpla.proto/tendermint/types/types");
var validator_1 = require("@xpla/xpla.proto/tendermint/types/validator");
...
var Commit = /** @class */ (function (_super) {
    ...
    Commit.fromData = function (data) {
        ...
        return new Commit(long_1.default.fromString(height), Number.parseInt(round), blockId ? BlockID.fromData(blockId) : undefined, signatures.map(function (sig) { return CommitSig.fromData(sig); }));
    };
...
var ValidatorSet = /** @class */ (function (_super) {
    ...
    ValidatorSet.fromData = function (data) {
        ...
        return new ValidatorSet(validators.map(function (val) { return Validator.fromData(val); }), proposer ? Validator.fromData(proposer) : undefined, long_1.default.fromString(total_voting_power));
    };
...
var Validator = /** @class */ (function (_super) {
    ...
    Validator.fromData = function (data) {
        ...
        return new Validator(address, pubKey ? crypto_1.PublicKey.fromData(pubKey) : undefined, long_1.default.fromString(votingPower), long_1.default.fromString(proposerPriority));
    };
