...
var connection_1 = require("@xpla/xpla.proto/ibc/core/connection/v1/connection");
...
Object.defineProperty(exports, "stateToJSON", { enumerable: true, get: function () { return connection_1.stateToJSON; } });
var connection_2 = require("@xpla/xpla.proto/ibc/core/connection/v1/connection");
/**
...
var IdentifiedConnection = /** @class */ (function (_super) {
    ...
    IdentifiedConnection.fromAmino = function (data) {
        ...
        return new IdentifiedConnection(id, client_id, versions.map(Version_1.Version.fromAmino), (0, connection_1.stateFromJSON)(state), counterparty ? Counterparty_1.Counterparty.fromAmino(counterparty) : undefined, Number.parseInt(delay_period));
    };
    IdentifiedConnection.prototype.toAmino = function () {
        ...
        var res = {
            ...
            state: (0, connection_1.stateToJSON)(state),
    ...
    IdentifiedConnection.fromData = function (data) {
        var id = data.id, client_id = data.client_id, versions = data.versions, state = data.state, counterparty = data.counterparty, delay_period = data.delay_period;
        return new IdentifiedConnection(id, client_id, versions.map(Version_1.Version.fromData), (0, connection_1.stateFromJSON)(state), counterparty ? Counterparty_1.Counterparty.fromData(counterparty) : undefined, Number.parseInt(delay_period));
    };
    ...
    IdentifiedConnection.prototype.toProto = function () {
        var _a = this, id = _a.id, client_id = _a.client_id, versions = _a.versions, state = _a.state, counterparty = _a.counterparty, delay_period = _a.delay_period;
        return connection_2.IdentifiedConnection.fromPartial({
            id: id,
            clientId: client_id,
