...
export declare class PeriodicAllowance extends JSONSerializable<PeriodicAllowance.Amino, PeriodicAllowance.Data, PeriodicAllowance.Proto> {
    ...
    static fromData(proto: PeriodicAllowance.Data, _isClassic?: boolean): PeriodicAllowance;
    toData(_isClassic?: boolean): PeriodicAllowance.Data;
    static fromProto(proto: PeriodicAllowance.Proto, _isClassic?: boolean): PeriodicAllowance;
    toProto(_isClassic?: boolean): PeriodicAllowance.Proto;
