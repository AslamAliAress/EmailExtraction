...
var tx_1 = require("@xpla/xpla.proto/cosmos/feegrant/v1beta1/tx");
/**
...
var MsgRevokeAllowance = /** @class */ (function (_super) {
    ...
    MsgRevokeAllowance.fromAmino = function (data, _isClassic) {
    ...
    MsgRevokeAllowance.fromData = function (proto, _isClassic) {
        var granter = proto.granter, grantee = proto.grantee;
        return new MsgRevokeAllowance(granter, grantee);
    };
    MsgRevokeAllowance.prototype.toData = function (_isClassic) {
        var _a = this, granter = _a.granter, grantee = _a.grantee;
        return {
    ...
    MsgRevokeAllowance.fromProto = function (proto, _isClassic) {
        return new MsgRevokeAllowance(proto.granter, proto.grantee);
    };
    MsgRevokeAllowance.prototype.toProto = function (_isClassic) {
        var _a = this, granter = _a.granter, grantee = _a.grantee;
