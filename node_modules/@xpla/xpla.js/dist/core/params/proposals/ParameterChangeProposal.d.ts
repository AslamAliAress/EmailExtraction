...
export declare class ParameterChangeProposal extends JSONSerializable<ParameterChangeProposal.Amino, ParameterChangeProposal.Data, ParameterChangeProposal.Proto> {
    ...
    static fromAmino(data: ParameterChangeProposal.Amino, _isClassic?: boolean): ParameterChangeProposal;
    toAmino(isClassic?: boolean): ParameterChangeProposal.Amino;
    static fromData(proto: ParameterChangeProposal.Data, _isClassic?: boolean): ParameterChangeProposal;
    toData(_isClassic?: boolean): ParameterChangeProposal.Data;
    static fromProto(proto: ParameterChangeProposal.Proto, _isClassic?: boolean): ParameterChangeProposal;
    toProto(_isClassic?: boolean): ParameterChangeProposal.Proto;
