...
var params_1 = require("@xpla/xpla.proto/cosmos/params/v1beta1/params");
/**
...
var ParameterChangeProposal = /** @class */ (function (_super) {
    ...
    ParameterChangeProposal.fromAmino = function (data, _isClassic) {
    ...
    ParameterChangeProposal.fromData = function (proto, _isClassic) {
    ...
    ParameterChangeProposal.prototype.toData = function (_isClassic) {
        var _a = this, title = _a.title, description = _a.description, changes = _a.changes;
        return {
    ...
    ParameterChangeProposal.fromProto = function (proto, _isClassic) {
        return new ParameterChangeProposal(proto.title, proto.description, ParamChange_1.ParamChanges.fromProto(proto.changes));
    };
    ParameterChangeProposal.prototype.toProto = function (_isClassic) {
        var _a = this, title = _a.title, description = _a.description, changes = _a.changes;
