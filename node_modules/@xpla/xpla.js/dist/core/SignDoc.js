...
var SignDoc = /** @class */ (function (_super) {
    ...
    SignDoc.prototype.toAmino = function (isClassic) {
        var _a = this, chain_id = _a.chain_id, account_number = _a.account_number, sequence = _a.sequence, _b = _a.tx_body, memo = _b.memo, messages = _b.messages, timeout_height = _b.timeout_height, _c = _a.auth_info, fee = _c.fee, tip = _c.tip;
        return {
            chain_id: chain_id,
