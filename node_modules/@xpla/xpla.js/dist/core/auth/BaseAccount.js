...
var BaseAccount = /** @class */ (function (_super) {
    ...
    BaseAccount.fromAmino = function (data, _isClassic) {
    ...
    BaseAccount.fromData = function (data, _isClassic) {
    ...
    BaseAccount.prototype.toData = function (_isClassic) {
        var _a = this, address = _a.address, public_key = _a.public_key, account_number = _a.account_number, sequence = _a.sequence;
        return {
    ...
    BaseAccount.prototype.toProto = function (_isClassic) {
        var _a = this, address = _a.address, public_key = _a.public_key, account_number = _a.account_number, sequence = _a.sequence;
    ...
    BaseAccount.fromProto = function (baseAccountProto, _isClassic) {
