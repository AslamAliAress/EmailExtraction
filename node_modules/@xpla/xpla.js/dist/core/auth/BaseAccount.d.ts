...
export declare class BaseAccount extends JSONSerializable<BaseAccount.Amino, BaseAccount.Data, BaseAccount.Proto> {
    ...
    static fromAmino(data: BaseAccount.Amino, _isClassic?: boolean): BaseAccount;
    static fromData(data: BaseAccount.Data, _isClassic?: boolean): BaseAccount;
    toData(_isClassic?: boolean): BaseAccount.Data;
    toProto(_isClassic?: boolean): BaseAccount.Proto;
    static fromProto(baseAccountProto: BaseAccount.Proto, _isClassic?: boolean): BaseAccount;
