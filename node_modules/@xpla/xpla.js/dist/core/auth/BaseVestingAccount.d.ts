...
export declare class BaseVestingAccount extends JSONSerializable<BaseVestingAccount.Amino, BaseVestingAccount.Data, BaseVestingAccount.Proto> {
    ...
    toData(_isClassic?: boolean): BaseVestingAccount.Data;
    static fromData(data: BaseVestingAccount.Data, _isClassic?: boolean): BaseVestingAccount;
    toProto(_isClassic?: boolean): BaseVestingAccount.Proto;
    static fromProto(proto: BaseVestingAccount.Proto, _isClassic?: boolean): BaseVestingAccount;
}
