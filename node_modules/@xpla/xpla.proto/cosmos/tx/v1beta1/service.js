...
function createBaseGetTxsEventRequest() {
    return { events: [], pagination: undefined, orderBy: 0, page: long_1.default.UZERO, limit: long_1.default.UZERO };
}
exports.GetTxsEventRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            page: isSet(object.page) ? long_1.default.fromValue(object.page) : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        if (!message.page.isZero()) {
            obj.page = (message.page || long_1.default.UZERO).toString();
        }
        if (!message.limit.isZero()) {
    ...
    fromPartial(object) {
        ...
        message.page = (object.page !== undefined && object.page !== null) ? long_1.default.fromValue(object.page) : long_1.default.UZERO;
        message.limit = (object.limit !== undefined && object.limit !== null) ? long_1.default.fromValue(object.limit) : long_1.default.UZERO;
        return message;
    },
};
function createBaseGetTxsEventResponse() {
    return { txs: [], txResponses: [], pagination: undefined, total: long_1.default.UZERO };
}
