...
exports.Capability = {
    ...
    fromJSON(object) {
        return { index: isSet(object.index) ? long_1.default.fromValue(object.index) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        if (!message.index.isZero()) {
...
exports.CapabilityOwners = {
    ...
    fromJSON(object) {
        return { owners: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.owners) ? object.owners.map((e) => exports.Owner.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.owners) === null || _a === void 0 ? void 0 : _a.length) {
            obj.owners = message.owners.map((e) => exports.Owner.toJSON(e));
        }
        return obj;
    },
    create(base) {
