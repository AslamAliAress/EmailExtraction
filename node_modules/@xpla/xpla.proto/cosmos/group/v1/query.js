...
function createBaseQueryGroupMembersRequest() {
    return { groupId: long_1.default.UZERO, pagination: undefined };
}
...
exports.QueryGroupMembersResponse = {
    ...
    fromJSON(object) {
        return {
            members: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.members) ? object.members.map((e) => types_1.GroupMember.fromJSON(e)) : [],
...
exports.QueryGroupsByAdminResponse = {
    ...
    fromJSON(object) {
        return {
            groups: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.groups) ? object.groups.map((e) => types_1.GroupInfo.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
...
exports.QueryVotesByProposalResponse = {
    ...
    fromJSON(object) {
        return {
            votes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.votes) ? object.votes.map((e) => types_1.Vote.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
