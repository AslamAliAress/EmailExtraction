...
function createBaseMsgCreateGroupResponse() {
    return { groupId: long_1.default.UZERO };
}
exports.MsgCreateGroupResponse = {
    ...
    fromJSON(object) {
        return { groupId: isSet(object.groupId) ? long_1.default.fromValue(object.groupId) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        if (!message.groupId.isZero()) {
...
function createBaseMsgUpdateGroupMembers() {
    return { admin: "", groupId: long_1.default.UZERO, memberUpdates: [] };
}
exports.MsgUpdateGroupMembers = {
    ...
    fromJSON(object) {
        return {
            admin: isSet(object.admin) ? globalThis.String(object.admin) : "",
            groupId: isSet(object.groupId) ? long_1.default.fromValue(object.groupId) : long_1.default.UZERO,
            memberUpdates: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.memberUpdates)
    ...
    toJSON(message) {
        ...
        if ((_a = message.memberUpdates) === null || _a === void 0 ? void 0 : _a.length) {
...
function createBaseMsgUpdateGroupAdmin() {
    return { admin: "", groupId: long_1.default.UZERO, newAdmin: "" };
}
...
function createBaseMsgUpdateGroupMetadata() {
    return { admin: "", groupId: long_1.default.UZERO, metadata: "" };
}
...
function createBaseMsgCreateGroupPolicy() {
    return { admin: "", groupId: long_1.default.UZERO, metadata: "", decisionPolicy: undefined };
}
...
function createBaseMsgCreateGroupWithPolicyResponse() {
    return { groupId: long_1.default.UZERO, groupPolicyAddress: "" };
}
...
function createBaseMsgWithdrawProposal() {
    return { proposalId: long_1.default.UZERO, address: "" };
}
...
function createBaseMsgVote() {
    return { proposalId: long_1.default.UZERO, voter: "", option: 0, metadata: "", exec: 0 };
}
exports.MsgVote = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.proposalId.isZero()) {
...
function createBaseMsgExec() {
    return { proposalId: long_1.default.UZERO, executor: "" };
}
exports.MsgExec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.proposalId.isZero()) {
...
function createBaseMsgLeaveGroup() {
    return { address: "", groupId: long_1.default.UZERO };
}
