...
function createBaseEventExec() {
    return { proposalId: long_1.default.UZERO, result: 0, logs: "" };
}
exports.EventExec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.proposalId.isZero()) {
...
function createBaseEventLeaveGroup() {
    return { groupId: long_1.default.UZERO, address: "" };
}
...
function createBaseEventProposalPruned() {
    return { proposalId: long_1.default.UZERO, status: 0, tallyResult: undefined };
}
