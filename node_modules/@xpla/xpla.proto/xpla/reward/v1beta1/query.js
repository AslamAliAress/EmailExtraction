...
exports.GrpcWebError = exports.GrpcWebImpl = exports.QueryPoolDesc = exports.QueryParamsDesc = exports.QueryDesc = exports.QueryClientImpl = exports.QueryPoolResponse = exports.QueryPoolRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.QueryParamsResponse = {
    ...
    fromJSON(object) {
        return { params: isSet(object.params) ? reward_1.Params.fromJSON(object.params) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.params !== undefined) {
            obj.params = reward_1.Params.toJSON(message.params);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.params = (object.params !== undefined && object.params !== null)
            ? reward_1.Params.fromPartial(object.params)
            : undefined;
        return message;
    },
};
...
exports.QueryPoolResponse = {
    ...
    fromJSON(object) {
        return { pool: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.pool) ? object.pool.map((e) => coin_1.Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.pool) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pool = message.pool.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryPoolResponse();
        message.pool = ((_a = object.pool) === null || _a === void 0 ? void 0 : _a.map((e) => coin_1.Coin.fromPartial(e))) || [];
        return message;
    },
};
...
exports.QueryDesc = { serviceName: "xpla.reward.v1beta1.Query" };
