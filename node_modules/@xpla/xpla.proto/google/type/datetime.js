...
exports.DateTime = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.utcOffset !== undefined) {
            duration_1.Duration.encode(message.utcOffset, writer.uint32(66).fork()).ldelim();
        }
    ...
    create(base) {
        return exports.DateTime.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseDateTime();
        message.year = (_a = object.year) !== null && _a !== void 0 ? _a : 0;
        message.month = (_b = object.month) !== null && _b !== void 0 ? _b : 0;
        message.day = (_c = object.day) !== null && _c !== void 0 ? _c : 0;
        message.hours = (_d = object.hours) !== null && _d !== void 0 ? _d : 0;
        message.minutes = (_e = object.minutes) !== null && _e !== void 0 ? _e : 0;
        message.seconds = (_f = object.seconds) !== null && _f !== void 0 ? _f : 0;
        message.nanos = (_g = object.nanos) !== null && _g !== void 0 ? _g : 0;
...
exports.TimeZone = {
    ...
    create(base) {
        return exports.TimeZone.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseTimeZone();
