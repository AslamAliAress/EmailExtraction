...
exports.GrpcWebError = exports.GrpcWebImpl = exports.MsgUpdateParamsDesc = exports.MsgEthereumTxDesc = exports.MsgDesc = exports.MsgClientImpl = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgEthereumTxResponse = exports.ExtensionOptionsEthereumTx = exports.DynamicFeeTx = exports.AccessListTx = exports.LegacyTx = exports.MsgEthereumTx = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.LegacyTx = {
    ...
    fromPartial(object) {
        ...
        message.v = (_e = object.v) !== null && _e !== void 0 ? _e : new Uint8Array(0);
        message.r = (_f = object.r) !== null && _f !== void 0 ? _f : new Uint8Array(0);
        message.s = (_g = object.s) !== null && _g !== void 0 ? _g : new Uint8Array(0);
        return message;
    },
};
...
exports.AccessListTx = {
    ...
    fromJSON(object) {
        return {
            ...
            value: isSet(object.value) ? globalThis.String(object.value) : "",
            data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
            accesses: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.accesses)
    ...
    toJSON(message) {
        ...
        if ((_a = message.accesses) === null || _a === void 0 ? void 0 : _a.length) {
            obj.accesses = message.accesses.map((e) => evm_1.AccessTuple.toJSON(e));
        }
        if (message.v.length !== 0) {
            obj.v = base64FromBytes(message.v);
        }
    ...
    fromPartial(object) {
        ...
        message.accesses = ((_f = object.accesses) === null || _f === void 0 ? void 0 : _f.map((e) => evm_1.AccessTuple.fromPartial(e))) || [];
        message.v = (_g = object.v) !== null && _g !== void 0 ? _g : new Uint8Array(0);
        message.r = (_h = object.r) !== null && _h !== void 0 ? _h : new Uint8Array(0);
        message.s = (_j = object.s) !== null && _j !== void 0 ? _j : new Uint8Array(0);
        return message;
    },
};
...
exports.DynamicFeeTx = {
    ...
    fromPartial(object) {
        ...
        message.accesses = ((_g = object.accesses) === null || _g === void 0 ? void 0 : _g.map((e) => evm_1.AccessTuple.fromPartial(e))) || [];
        message.v = (_h = object.v) !== null && _h !== void 0 ? _h : new Uint8Array(0);
        message.r = (_j = object.r) !== null && _j !== void 0 ? _j : new Uint8Array(0);
        message.s = (_k = object.s) !== null && _k !== void 0 ? _k : new Uint8Array(0);
        return message;
    },
};
...
function createBaseMsgEthereumTxResponse() {
    return { hash: "", logs: [], ret: new Uint8Array(0), vmError: "", gasUsed: long_1.default.UZERO };
}
exports.MsgEthereumTxResponse = {
    ...
    fromJSON(object) {
        return {
            hash: isSet(object.hash) ? globalThis.String(object.hash) : "",
            logs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.logs) ? object.logs.map((e) => evm_1.Log.fromJSON(e)) : [],
    ...
    toJSON(message) {
        ...
        if ((_a = message.logs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.logs = message.logs.map((e) => evm_1.Log.toJSON(e));
        }
        if (message.ret.length !== 0) {
...
class MsgClientImpl {
    ...
    EthereumTx(request, metadata) {
        return this.rpc.unary(exports.MsgEthereumTxDesc, exports.MsgEthereumTx.fromPartial(request), metadata);
    }
...
exports.MsgDesc = { serviceName: "ethermint.evm.v1.Msg" };
exports.MsgEthereumTxDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.MsgEthereumTx.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.MsgEthereumTxResponse.decode(data);
