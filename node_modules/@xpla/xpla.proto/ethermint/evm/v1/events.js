...
exports.EventTxLog = {
    ...
    fromJSON(object) {
        return {
            txLogs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.txLogs) ? object.txLogs.map((e) => globalThis.String(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.txLogs) === null || _a === void 0 ? void 0 : _a.length) {
