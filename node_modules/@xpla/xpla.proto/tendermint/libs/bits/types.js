...
exports.BitArray = {
    ...
    fromJSON(object) {
        return {
            ...
            elems: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.elems) ? object.elems.map((e) => long_1.default.fromValue(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        ...
        if ((_a = message.elems) === null || _a === void 0 ? void 0 : _a.length) {
