...
exports.GrpcWebError = exports.GrpcWebImpl = exports.ABCIApplicationProcessProposalDesc = exports.ABCIApplicationPrepareProposalDesc = exports.ABCIApplicationApplySnapshotChunkDesc = exports.ABCIApplicationLoadSnapshotChunkDesc = exports.ABCIApplicationOfferSnapshotDesc = exports.ABCIApplicationListSnapshotsDesc = exports.ABCIApplicationEndBlockDesc = exports.ABCIApplicationBeginBlockDesc = exports.ABCIApplicationInitChainDesc = exports.ABCIApplicationCommitDesc = exports.ABCIApplicationQueryDesc = exports.ABCIApplicationCheckTxDesc = exports.ABCIApplicationDeliverTxDesc = exports.ABCIApplicationInfoDesc = exports.ABCIApplicationFlushDesc = exports.ABCIApplicationEchoDesc = exports.ABCIApplicationDesc = exports.ABCIApplicationClientImpl = exports.Snapshot = exports.Misbehavior = exports.ExtendedVoteInfo = exports.VoteInfo = exports.ValidatorUpdate = exports.Validator = exports.TxResult = exports.EventAttribute = exports.Event = exports.ExtendedCommitInfo = exports.CommitInfo = exports.ResponseProcessProposal = void 0;
/* eslint-disable */
...
function createBaseRequestQuery() {
    return { data: new Uint8Array(0), path: "", height: long_1.default.ZERO, prove: false };
}
...
exports.RequestBeginBlock = {
    ...
    toJSON(message) {
        ...
        if (message.lastCommitInfo !== undefined) {
            obj.lastCommitInfo = exports.CommitInfo.toJSON(message.lastCommitInfo);
        }
        if ((_a = message.byzantineValidators) === null || _a === void 0 ? void 0 : _a.length) {
            obj.byzantineValidators = message.byzantineValidators.map((e) => exports.Misbehavior.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.RequestPrepareProposal = {
    ...
    toJSON(message) {
        ...
        const obj = {};
        if (!message.maxTxBytes.isZero()) {
            obj.maxTxBytes = (message.maxTxBytes || long_1.default.ZERO).toString();
        }
    ...
    fromPartial(object) {
        ...
        message.nextValidatorsHash = (_d = object.nextValidatorsHash) !== null && _d !== void 0 ? _d : new Uint8Array(0);
        message.proposerAddress = (_e = object.proposerAddress) !== null && _e !== void 0 ? _e : new Uint8Array(0);
        return message;
    },
};
...
exports.RequestProcessProposal = {
    ...
    fromPartial(object) {
        ...
        message.nextValidatorsHash = (_e = object.nextValidatorsHash) !== null && _e !== void 0 ? _e : new Uint8Array(0);
        message.proposerAddress = (_f = object.proposerAddress) !== null && _f !== void 0 ? _f : new Uint8Array(0);
        return message;
    },
};
...
exports.ResponseInfo = {
    ...
    fromPartial(object) {
        ...
        message.lastBlockHeight = (object.lastBlockHeight !== undefined && object.lastBlockHeight !== null)
            ...
            : long_1.default.ZERO;
        message.lastBlockAppHash = (_c = object.lastBlockAppHash) !== null && _c !== void 0 ? _c : new Uint8Array(0);
        return message;
    },
};
...
exports.ResponseQuery = {
    ...
    fromPartial(object) {
        ...
        message.key = (_d = object.key) !== null && _d !== void 0 ? _d : new Uint8Array(0);
        message.value = (_e = object.value) !== null && _e !== void 0 ? _e : new Uint8Array(0);
...
function createBaseResponseCommit() {
    return { data: new Uint8Array(0), retainHeight: long_1.default.ZERO };
}
...
function createBaseTxResult() {
    return { height: long_1.default.ZERO, index: 0, tx: new Uint8Array(0), result: undefined };
}
exports.TxResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.height.isZero()) {
    ...
    fromPartial(object) {
        ...
        message.height = (object.height !== undefined && object.height !== null)
            ...
            : long_1.default.ZERO;
        message.index = (_a = object.index) !== null && _a !== void 0 ? _a : 0;
        message.tx = (_b = object.tx) !== null && _b !== void 0 ? _b : new Uint8Array(0);
...
function createBaseValidator() {
    return { address: new Uint8Array(0), power: long_1.default.ZERO };
}
exports.Validator = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
exports.ExtendedVoteInfo = {
    ...
    fromPartial(object) {
        ...
        message.validator = (object.validator !== undefined && object.validator !== null)
            ...
            : undefined;
        message.signedLastBlock = (_a = object.signedLastBlock) !== null && _a !== void 0 ? _a : false;
        message.voteExtension = (_b = object.voteExtension) !== null && _b !== void 0 ? _b : new Uint8Array(0);
        return message;
    },
};
...
function createBaseSnapshot() {
    return { height: long_1.default.UZERO, format: 0, chunks: 0, hash: new Uint8Array(0), metadata: new Uint8Array(0) };
}
exports.Snapshot = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.height.isZero()) {
    ...
    fromPartial(object) {
        ...
        message.hash = (_c = object.hash) !== null && _c !== void 0 ? _c : new Uint8Array(0);
        message.metadata = (_d = object.metadata) !== null && _d !== void 0 ? _d : new Uint8Array(0);
        return message;
    },
};
