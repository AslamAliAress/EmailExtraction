...
function createBaseMaxCallsLimit() {
    return { remaining: long_1.default.UZERO };
}
exports.MaxCallsLimit = {
    ...
    fromJSON(object) {
        return { remaining: isSet(object.remaining) ? long_1.default.fromValue(object.remaining) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        if (!message.remaining.isZero()) {
            obj.remaining = (message.remaining || long_1.default.UZERO).toString();
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.remaining = (object.remaining !== undefined && object.remaining !== null)
            ? long_1.default.fromValue(object.remaining)
...
function createBaseCombinedLimit() {
    return { callsRemaining: long_1.default.UZERO, amounts: [] };
}
exports.CombinedLimit = {
    ...
    fromJSON(object) {
        return {
            callsRemaining: isSet(object.callsRemaining) ? long_1.default.fromValue(object.callsRemaining) : long_1.default.UZERO,
            amounts: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.amounts) ? object.amounts.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.callsRemaining = (object.callsRemaining !== undefined && object.callsRemaining !== null)
            ? long_1.default.fromValue(object.callsRemaining)
            : long_1.default.UZERO;
        message.amounts = ((_a = object.amounts) === null || _a === void 0 ? void 0 : _a.map((e) => coin_1.Coin.fromPartial(e))) || [];
        return message;
    },
