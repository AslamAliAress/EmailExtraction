...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            ...
            allowMessages: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.allowMessages)
    ...
    toJSON(message) {
        ...
        if ((_a = message.allowMessages) === null || _a === void 0 ? void 0 : _a.length) {
